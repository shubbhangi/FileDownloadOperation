...
import com.app.file.exception.FileStorageException;
import com.app.file.exception.MyFileNotFoundException;
...
public class FileStorageService {
	...
	public String storeFile(MultipartFile file) {
		...
		String fileName = StringUtils.cleanPath(System.currentTimeMillis() + getFileExtension(file));
